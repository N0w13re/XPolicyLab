...
Usage:
  scripts/summarize_robodojo_layout_shards.py --task general_pickup \
      --policy Pi_05_Agent_P1_RPent --layouts 50 --run-glob '2026-09-02_gpick-*'
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--eval-root", default="/mnt/bn/robotics-data-mx/wenbo/RoboDojo-eval"
    )
    parser.add_argument(
        "--trace-root", default="/mnt/bn/robotics-data-mx/wenbo/xpolicylab-rpent-traces"
    )
