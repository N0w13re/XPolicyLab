...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **31/42**. New cell: `pour_liquid_into_cup` 18/50 (15/25+3/25). Five-dimension partial Average **15.13%** (**not vs 14.88**). Official eps 1550. Wrist YMAX pour_liquid_random ep24 252/253/250. GPU2 now `store_laptop_and_headphones` (random already 25). Native `--num_envs 5`. | not started |
