...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **36/42**. New cells: `hang_mugs` 1/50, `stack_blocks_by_language` 0/50, `store_laptop_and_headphones` 4/50. Five-dimension partial Average **13.46%** (**not vs 14.88**). Official eps 1800. Last 6 G05 tasks in flight. Wrist YMAX store_laptop ep24 255/173/255. Native `--num_envs 5`. | not started |
| Xiaomi_Robotics_1 | `RoboDojo-sim-arx_x5-ee-0` | ee | **cancelled** (user 2026-08-27 17:41 CST): native not evaluated. Smoke 2/2 only. Elastic scheduler stopped; Xiaomi GPU2/3 jobs killed. | not started |
