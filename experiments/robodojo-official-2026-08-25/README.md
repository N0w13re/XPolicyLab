...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **33/42**. New cells: `plug_in_charger` 1/50, `swap_T` 0/50. Five-dimension partial Average **13.88%** (**not vs 14.88**). Official eps 1650. Memory dim 6/6. Wrist YMAX plug_in_charger ep49 251/255/252; swap_T 255/176/189. Native `--num_envs 5`. | not started |
