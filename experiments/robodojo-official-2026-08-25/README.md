...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **22/42**. New: `pack_objects_into_box` 0/50 (Gen 25+25; wrist YMAX 255/255/255) and `pour_balls_into_vase` 15/50 (Precision). Five-dimension partial Average **14.15%** (**not vs 14.88**). Official eps 1100. Native `--num_envs 5`. | not started |
