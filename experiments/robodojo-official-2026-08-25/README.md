...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **42/42** seed-0 closed-loop. Official-style five-dimension Average SR **12.55%** vs official 14.88 (**delta -2.33**, within 5 abs). Native `--num_envs 5`, untiled cameras. | not started |
| Xiaomi_Robotics_1 | `RoboDojo-sim-arx_x5-ee-0` | ee | **cancelled** by user: native not evaluated. Smoke 2/2 only. | not started |
