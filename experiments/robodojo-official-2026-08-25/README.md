...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **20/42**. New: `make_toast` 5/50 (first Generalization cell; 25+25), `match_and_pick_from_conveyor` 17/50, `put_bottles_into_dustbin` 43/50 (Long-Horizon now **8/8** at 21.5%). Five-dimension partial Average **15.62%** (**not vs 14.88** until 42/42). Official eps 1000. Native `--num_envs 5`. | not started |
