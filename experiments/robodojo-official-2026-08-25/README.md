...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **17/42**. New: `swap_blocks` 0/50 (Memory; wrist YMAX ep49 255/241/246). Partial four-dimension Average SR **13.20%** (no complete Generalization cell; **not vs 14.88**). Official eps 850. Native `--num_envs 5`. | not started |
