...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **28/42**. New official cell: `sweep_blocks` 0/50 (std+random 25+25). Five-dimension partial Average **12.78%** (**not vs 14.88**). Official eps 1400. Wrist YMAX on `sweep_blocks` ep24 250/250/255. Native `--num_envs 5`. | not started |
