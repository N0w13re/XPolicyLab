...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **30/42**. New cells: `stack_bowls` 26/50 (20/25+6/25), `solve_equation` 0/50. Five-dimension partial Average **14.42%** (**not vs 14.88**). Official eps 1500. Wrist YMAX stack_bowls ep24 250/228/255; solve_equation ep49 255/255/245. GPU5 `hang_mugs` (random already done). Native `--num_envs 5`. | not started |
