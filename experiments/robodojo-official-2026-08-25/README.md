...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **16/42**. New: `press_by_number` 0/50 (Memory; wrist YMAX ep49 251/226/195) and `fill_egg_holder` 0/50 (Long-Horizon; 255/254/255). Partial four-dimension Average SR **13.49%** (no complete Generalization cell; **not vs 14.88**). Official eps 800. Native `--num_envs 5`. | not started |
