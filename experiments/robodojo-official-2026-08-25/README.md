...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **13/42**. New: `store_tools_in_toolbox` 0/50. Partial four-dimension Average SR **14.58%** (no complete Generalization cell; **not vs 14.88**). In-progress 90/724 (12.43% micro). Wrist YMAX on store_tools ep49 253/255/247. Native `--num_envs 5`. | not started |
