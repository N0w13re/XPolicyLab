...
| G05 | `RoboDojo-sim-arx_x5-joint-0` | joint | **27/42**. New: `align_blocks` 0/50, `insert_tubes` 22/50, `play_Xylophone` 1/50, `arrange_largest_number` 0/50, `sort_nesting_dolls_by_size` 2/50. Five-dimension partial Average **12.92%** (**not vs 14.88**). Official eps 1350. Native `--num_envs 5`. | not started |
